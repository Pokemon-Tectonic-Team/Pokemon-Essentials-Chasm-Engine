...
BattleHandlers::DamageCalcUserItem.add(:BUGGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :BUG, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:FAIRYGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :FAIRY, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:FIGHTINGGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :FIGHTING, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:FIREGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :FIRE, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:FLYINGGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :FLYING, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:GHOSTGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :GHOST, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:GRASSGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :GRASS, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:DARKGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :DARK, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:DRAGONGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :DRAGON, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:ELECTRICGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :ELECTRIC, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:GROUNDGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :GROUND, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:ICEGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :ICE, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:NORMALGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :NORMAL, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:POISONGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :POISON, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:PSYCHICGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :PSYCHIC, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:ROCKGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :ROCK, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:WATERGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :WATER, move, mults, type, aiCheck, ai_context)
  }
)

BattleHandlers::DamageCalcUserItem.add(:STEELGEM,
  proc { |item, user, _target, move, mults, _baseDmg, type, aiCheck, ai_context|
      pbBattleGem(item, user, :STEEL, move, mults, type, aiCheck, ai_context)
  }
)
...
BattleHandlers::DamageCalcUserItem.add(:STRENGTHHERB,
  proc { |item, user, target, move, mults, _baseDmg, type, aiCheck, ai_context|
