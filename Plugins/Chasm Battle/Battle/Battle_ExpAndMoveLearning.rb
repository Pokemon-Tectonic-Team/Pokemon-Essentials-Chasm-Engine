        ...
        if bossBattle?
            ...
            @battlers.each do |b|
                ...
                b.participants.each do |partic|
                    ...
                    next unless p1[partic].able?(false, ALL_ABLE_PARAMETERS) || Settings::FAINTED_POKEMON_EARN_EXP
                    numPartic += 1
                end
                ...
                unless expAll
                    eachInTeam(0, 0) do |pkmn, i|
                        next unless pkmn.able?(false, ALL_ABLE_PARAMETERS) || Settings::FAINTED_POKEMON_EARN_EXP
