class PokeBattle_AI
    ...
    # Damage calculation
    #=============================================================================
    def pbTotalDamageAI(move, user, target, numTargets = 1, ai_context = nil)
        ...
        damage = move.calculateDamageForHitAI(user, target, type, baseDmg, numTargets, ai_context)
    ...
    #===========================================================================
    def pbRoughAccuracy(move, user, target, ai_context = nil)
        ...
        move.pbCalcAccuracyModifiers(user, target, modifiers, true, type, ai_context)
        # Calculation
